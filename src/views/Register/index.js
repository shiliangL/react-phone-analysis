...
import { List, InputItem, Flex, Button, Radio, TextareaItem } from 'antd-mobile';
...
class Register extends Component {
  ...
  toRegister = () => {
    ...
    const data = {
      ...
      desc: this.TextareaItem.state.value,
      type
    }
    userRegisger(data)
  }
  ...
  render() {
    ...
    const itemType = (type)=>{
      return <TextareaItem title="简介" placeholder="..." ref={el => this.TextareaItem = el} autoHeight />
    } 
      ...
      <div className="front-page">
        <div className="front-content">
          ...
          <List renderHeader={() => '欢迎注册'}>
            <InputItem ref={el => this.InputItemName = el} > 名称 </InputItem>
            <InputItem ref={el => this.InputItemKey = el} > 密码 </InputItem>
